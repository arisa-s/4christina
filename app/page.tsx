  ...
  return (
    <div className="columns-3 gap-4 space-y-6 ml-20">
      ...
      <AutoplayVideo
        ...
        width={1330}
        height={1836}
        className="w-full -ml-24 cursor-pointer"
      />
      <AutoplayVideo
        ...
        width={1440}
        height={1920}
        className="w-full cursor-pointer -ml-20"
      />
      ...
      <AutoplayVideo
        ...
        width={1146}
        height={1042}
        className="w-4/5 -ml-52 cursor-pointer"
      />
      <AutoplayVideo
      ...
      <ImageLink
        ...
        alt="hero"
        className="w-2/3 -ml-24 cursor-pointer"
      />
      ...
      <ImageLink
        ...
        alt="hero"
        className="w-5/6 -ml-4 cursor-pointer"
      />
      <div className="w-full h-12"></div>
      <ImageLink
        src={home8}
      ...
      <ImageLink
        ...
        href=""
        alt="hero"
        className="w-full -ml-40 cursor-pointer"
        style={{ height: "23%" }}
      />
